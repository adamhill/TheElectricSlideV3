...
struct ParserAndErrorHandlingTests {
    ...
    // MARK: - Circular Specification Tests
    ...
    // MARK: - ScaleBuilder Validation Tests
    ...
    // MARK: - StandardScales Lookup Tests
