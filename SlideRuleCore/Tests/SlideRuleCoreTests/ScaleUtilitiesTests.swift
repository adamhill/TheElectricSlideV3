...
struct ScaleUtilitiesTests {
    ...
    struct AnalysisTests {
        ...
        func tickDensityVariation() {
            ...
            // Log scale compresses high values, so early regions should be denser
            #expect(densities[0] > densities[9], "Early regions should be denser than later regions for log scale")
        }
